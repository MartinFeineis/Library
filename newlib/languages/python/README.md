...
the logger object takes several arguments, the first on is the message that needs to be one string. Not like the [print](https://docs.python.org/3/library/functions.html?highlight=print#print) function that automatically concatenates its arguments to a string
...
[Jupyter Notebook](https://github.com/MartinFeineis/Library/blob/master/Python/test.ipynb)
