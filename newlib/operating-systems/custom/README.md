...
Install, verify `zsh` location and change it to default shell :white\_check\_mark: Verified on Acer Extensa with AntiXLinux
...
:white\_check\_mark: Verified on Acer Extensa with AntiXLinux More [here](https://github.com/zsh-users/zsh-syntax-highlighting)
...
:white\_check\_mark: Verified on Acer Extensa with AntiXLinux To make things look nice, more info [here](https://github.com/spaceship-prompt/spaceship-prompt)
...
:white\_check\_mark: Verified on Acer Extensa with AntiXLinux more info [here](https://github.com/zsh-users/zsh-completions)
...
:white\_check\_mark: Verified on Acer Extensa with AntiXLinux See Documentation [here](https://github.com/zsh-users/zsh-autosuggestions/blob/master/INSTALL.md)
...
check [here](https://www.nerdfonts.com/font-downloads) Install and clean up UbuntuMono Nerdfonts regular, bold, italic and bold-italic
...
Vivid to update (LS\_COLORS)\[https://github.com/sharkdp/vivid]
...
:white\_check\_mark: Verified on Acer Extensa with AntiXLinux [Github](https://github.com/lsd-rs/lsd)
