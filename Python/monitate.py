...
#
# - given the root URL "https://www.testdomaine.com/" recursively
# follow all <a> tags relative to https://www.testdomaine.com/ and
...
# parser.parse_args()
# parser.add_argument("--website", type=str, default="https://www.testdomaine.com", help="Webaddress to scrap Links from")
# parser.add_argument("--depth", type=int, default=0, help="Level to follow links down to")
# args = parser.parse_args()
web_url = "https://www.testURL.com" #args.website
depth = 2 #args.depth
